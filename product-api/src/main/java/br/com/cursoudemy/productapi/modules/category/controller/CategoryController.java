...
public class CategoryController {
    ...
    @PutMapping("{id}")
    public CategoryResponse updateById(@RequestBody CategoryRequest categoryRequest,@PathVariable Integer id) {
        return categoryService.updateById(categoryRequest, id);
    }
