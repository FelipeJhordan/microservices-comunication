...
public class SupplierController {
    ...
    @PutMapping("{id}")
    public SupplierResponse updateById(@RequestBody SupplierRequest supplierRequest, @PathVariable Integer id) {
        return supplierService.updateById(supplierRequest, id);
    }
